...
#define CAMERA_POWER_PATH "/sys/devices/platform/uvc_camera/uvc_camera_power"
struct buffer {
        void *                  start;
        size_t                  length;
};
...
jint Java_com_camera_simplewebcam_CameraPreview_powerOnOffCamera( JNIEnv* env,jobject thiz, jint power);
jint Java_com_camera_simplewebcam_CameraPreview_prepareCamera( JNIEnv* env,jobject thiz, jint videoid);
jint Java_com_camera_simplewebcam_CameraPreview_prepareCameraWithBase( JNIEnv* env,jobject thiz, jint videoid, jint videobase, jint width, jint height);
jbyteArray Java_com_camera_simplewebcam_CameraPreview_processCamera( JNIEnv* env,jobject thiz);
